...
import org.usfirst.frc.team2340.robot.commands.AcquateClose1Command;
import org.usfirst.frc.team2340.robot.commands.AcquateClose2Command;
import org.usfirst.frc.team2340.robot.commands.AcquateCloseCommand;
import org.usfirst.frc.team2340.robot.commands.AcquateCommand;
import org.usfirst.frc.team2340.robot.commands.AcquateOpen1Command;
import org.usfirst.frc.team2340.robot.commands.AcquateOpen2Command;
import org.usfirst.frc.team2340.robot.commands.AcquateOpenCommand;
...
public class OI {
	 ...
	 LogitechF310 driveController = new LogitechF310("Drive Controller",
	    ...
	    private void checkacquistionController(){
	    	...
	    	acquistionController.getLBButton().whenPressed(new AcquateOpenCommand());
	    	acquistionController.getRBButton().whenPressed(new AcquateCloseCommand() );
	   ...
	   // public getDampenSpeedRB(){
	    //	return driveController.getRBButton();
	   // }
